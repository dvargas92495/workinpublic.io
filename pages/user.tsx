...
import { SignedIn, useUser, UserButton, UserProfile } from "@clerk/clerk-react";
...
const AccountContent = () => {
  ...
  useEffect(() => {
    ...
    const clerkMain = document.getElementsByClassName(
      "cl-user-profile"
    )[0] as HTMLDivElement;
    if (clerkMain) clerkMain.style.height = "unset";
  ...
  font-family: "Century Gothic", sans-serif
      ...
      <Card
        ...
        sx={{
          width: "840px",
          borderRadius: "8px",
          boxShadow: "var(--clerk-box-shadow, 0px 2px 8px rgba(0, 0, 0, 0.2))",
          padding: "2em 1em",
          marginBottom: "2em",
        }}
      >
...
const TABS = [
  { text: "Account", Icon: HomeIcon, content: AccountContent, nested: false },
  {
    text: "Funding Board",
